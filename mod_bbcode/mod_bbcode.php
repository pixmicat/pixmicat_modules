...
class mod_bbcode extends ModuleHelper { 
	...
	public function autoHookPostInfo(&$postinfo){
		$postinfo .= "<li>可使用 <a href='".$this->myPage."' target='_blank'>BBCode</a></li>\n";
	}
...
<li>要注音顯示時, 可使用 <b>[ruby][/ruby]</b>, 例如:<br/><br/><b>[ruby]漢[rp]([/rp][rt]Kan[/rt][rp])[/rp]字[rp]([/rp][rt]ji[/rt][rp])[/rp][/ruby]</b><br/><br/>將會變成<ruby>漢<rp>(</rp><rt>Kan</rt><rp>)</rp>字<rp>(</rp><rt>ji</rt><rp>)</rp></ruby></li>
</ul>
